            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/admin/member/index">公告管理</a>
                            <i class="icon-angle-right"></i>
                        </li>
                        <li><a href="#">公告列表</a></li>
                    </ul>
                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            ...
                            <a class="btn green" href="/admin/notice/input">添加公告</a>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach var="item" items="${list}">
                                    <tr class="odd gradeX">
                                        ...
                                        <td >
                                            <a class="btn green" href="/admin/notice/input?id=${item.id}">修改</a>
...
<div id="static" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    ...
    <form id="modelDeleteForm" action="/admin/notice/delete" method="post">
